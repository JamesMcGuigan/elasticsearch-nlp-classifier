...
/**
 * DOCS:
 * - https://www.elastic.co/guide/en/elasticsearch/client/java-rest/7.10/java-rest-high.html
 * - https://www.baeldung.com/elasticsearch-java
 */
public class ESClient {
    public static RestHighLevelClient client;
    private final SnifferBuilder sniffer;
    ...
    public ESClient() {
        ...
        credentialsProvider.setCredentials(
            AuthScope.ANY,
            new UsernamePasswordCredentials("dabq1f04lo", "tdxgdpvqq8")
        );

        RestClientBuilder builder = RestClient.builder(
                new HttpHost(
                    "kaggle-tweets-3926018095.us-east-1.bonsaisearch.net",
                    443,
                    "https"
                )
            )
                ...
                new RestClientBuilder.RequestConfigCallback() {
                    ...
                    public RequestConfig.Builder customizeRequestConfig(RequestConfig.Builder requestConfigBuilder) {
                        return requestConfigBuilder
                            .setConnectTimeout(5000)  // default 1s
                            .setSocketTimeout(60000)  // default 30s
                        ;
                    }
                }
            )
